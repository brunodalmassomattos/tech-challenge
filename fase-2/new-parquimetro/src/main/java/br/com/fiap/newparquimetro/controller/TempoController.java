...
public class TempoController {
    ...
    @PostMapping
    public ResponseEntity<ControleTempoResponseDTO> cadastroTempo(@Valid @RequestHeader String idCondutor,
                                                                  @RequestHeader(required = false) Long tempo,
                                                                  @RequestHeader String tipo) {
